...
public class Exe29_MaxMinPQ2 <T extends Comparable<T>> {
    ...
    private static void test() {
        Exe29_MaxMinPQ2<Integer> exe29_maxMinPQ = new Exe29_MaxMinPQ2<>();
        int testTime = 100;
        int maxNum = 10;
        int deleteMaxRate = 20;
        int deleteMinRate = 20;
